...
export class StepModel {
    ...
    constructor(StepID: string, StepNAME: string, StepDESCRIPTION: string, StepSTEPCOLORCODE: string, StepMAXPROCESSTIME: string, StepISINITSTEP: boolean, StepISFINISHSTEP: boolean, listNextStep: string[],
     isEdit: boolean, StepSTATUS: string, WORKSSUPPORTSTEPPROGRESS: string, isMustChooseProcessUser: boolean) {
        this.StepID = StepID;
        ...
        this.WORKSSUPPORTSTEPPROGRESS = WORKSSUPPORTSTEPPROGRESS;
        this.isMustChooseProcessUser = isMustChooseProcessUser;
    }
}
