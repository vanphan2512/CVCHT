...
function createModule() {
    ...
    module.addRoutes([
        // Add project route
        { path: route.project.projects.path, name: route.project.projects.name, component: Projects, data: { authentication: AuthenticationMode.Require } , useAsDefault: true },
        ...
        // add workdetail
        { path: route.work.detail.path, name: route.work.detail.name, component: WorkDetail, data: { authentication: AuthenticationMode.Require } },
        // add report
        { path: route.report.report.path, name: route.report.report.name, component: Report, data: { authentication: AuthenticationMode.Require } }
