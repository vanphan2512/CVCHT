export class EditModel {
    ...
    constructor(Id: number, WorksSupportQualityName: string, OrderIndex: number, Description: string,IconUrl: string,ColorCode: string ,IsActived: boolean, IsSystem: boolean, User: string ) {
        this.Id = Id;
