        ...
        if (!isCanDelete) {
            this.options = {
                columns: [                   
                    ...
                    { field: "ColorCode", title: resourceHelper.resolve("configurations.priorities.grid.color"), type: "color", index: 4, sort: "false", className: "text-center", width: "7%" },
                    { field: "IsSystem", title: resourceHelper.resolve("configurations.priorities.grid.isSystem"), type: "checkbox", index: 5, width: "8%", className: "text-center" },
                    { field: "IsActived", title: resourceHelper.resolve("configurations.priorities.grid.isActive"), type: "toggle", index: 6, width: "8%", className: "text-center", sort: "true" }
                ],
                data: [],
                enableEdit: true,
                enableDelete: false,
