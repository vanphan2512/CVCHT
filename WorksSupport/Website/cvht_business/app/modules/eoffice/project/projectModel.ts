...
export class UpdateModel {
    ...
    public User: string = String.empty;
    constructor(id: string, worksSupportProjectName: string, worksSupportTypeId: string, description: string, orderIndex: string, isActived: number, isSystem: number, user: string) {
        this.Id = id;
