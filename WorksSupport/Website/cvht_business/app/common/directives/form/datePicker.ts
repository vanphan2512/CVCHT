...
export class FormDatePicker extends BaseControl {
    ...
    private daysOfWeek: any = ["CN", "T2", "T3", "T4", "T5", "T6", "T7"];
    private monthNames: any = ["Tháng 1", "Tháng 2", "Tháng 3", "Tháng 4", "Tháng 5", "Tháng 6",
    ...
    protected onReady() {
        ...
        self.DataPicker = window.jQuery("#" + this.id).daterangepicker({
            ...
            function (selectedValue: Date) {
                ...
                self.modelChange.emit(self.convertDateToString(objDate));
            }
        );
        self.modelChange.emit(self.nowDate());
        self.model = self.nowDate();
    }
    private convertDateToString(objDate: Date) {
    ...
    public resetDateEdit(startDate: any) {
        ...
        self.modelChange.emit(startDate);
        self.model = startDate;
    }
    ...
    private checkKeyCodeDate(event: any): boolean {
