...
export class MenuSidebar implements AfterViewInit {
    ...
    private initializedSidebar(): any {
        ...
        $(document).ready(function () {
            ...
            // set value default when login into system
            if ((CURRENT_URL.split('/')).slice(-1).toString() == "dang-nhap" ) {               
                $SIDEBAR_MENU.find('a[href="/do-uu-tien"]').parent('li').addClass('current-page active');
            }
