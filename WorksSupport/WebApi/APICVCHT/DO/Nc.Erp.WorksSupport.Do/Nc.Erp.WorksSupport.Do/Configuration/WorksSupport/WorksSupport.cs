...
namespace Nc.Erp.WorksSupport.Do.Configuration.WorksSupport
{
    ...
    public class WorkSupport
    {
        ...
        public string WorksSupportQualityNode { get; set; }
        ...
        public string WorkSupportStatusColor { get; set; }
        ...
        public List<WorksSupportAttachment> ListWorksSupportAttachment { get; set; }
        
        //Tiến độ công việc cần hỗ trợ
        public List<WorksSupportProgress> ListWorksSupportProgressHistory { get; set; }

        public List<WorksSupportWorkflow> ListWorksSupportWorkFlow { get; set; }
        ...
        private int intWorksSupportStepId;
        private int intNextWorksSupportStepId;
