...
namespace Nc.Erp.WorksSupport.Api.Features.WorksSupport
{
    ...
    public class GroupController : BaseController
    {
        ...
        [HttpGet]
        [Route("GetworksGroupByProjectId/{projectId}/{keyWords}")]
        public Response<List<WorksSupportGroup>> GetworksGroupByKeyWords([FromUri] int projectId, string keyWords)
        {
            // Definition object to return.
            var ret = new Response<List<WorksSupportGroup>>();
            try
            {
                ...
                // Call DaWorksSupportGroup to search data.
                var objResultMessage = new DaWorksSupportGroup().SearchWorksGroupsByKeyWords(ref obj, projectId, keyWords);
