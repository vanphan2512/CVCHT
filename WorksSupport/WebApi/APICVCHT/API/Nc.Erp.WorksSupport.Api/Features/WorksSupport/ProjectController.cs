...
namespace Nc.Erp.WorksSupport.Api.Features.WorksSupport
{
    ...
    public class ProjectController : BaseController
    {
        ...
        /// <summary>
        /// lấy dự án theo username
        /// </summary>
        /// <param name="userName"></param>
        /// <returns></returns>
        [HttpGet]
        [Route("GetProjectByMemberId/{userName}")]
        public Response<List<WorksSupportProject>> GetProjectByMemberId(string userName )
        {
            // Definition object to return.
            var ret = new Response<List<WorksSupportProject>>();
            try
            {
                // Definition object return
                var listWorksSupportType = new List<WorksSupportProject>();
                var objResultMessage = new DaWorksSupportProject().GetProjectByMemberId(ref listWorksSupportType, userName);
        ...
        /// <returns></returns>
        [HttpGet]
        [Route("CheckUserProcess/{userName}/{projectId}")]
        public Response<WorksSupportProject> CheckUserProcess(string userName, int projectId)
        {
            // Definition object to return.
            var ret = new Response<WorksSupportProject>();
            try
            {
                // Definition object return
                var objProject = new WorksSupportProject();
                var objResultMessage = new DaWorksSupportProject().CheckUserIsProccess(ref objProject, userName, projectId);
