...
namespace WebClientAuthen
{
    public class RDAuthorize : ActionFilterAttribute
    {
        ...
        /// <param name="WSHostName"></param>
        /// <returns></returns>
        public static string GetAuthenData(string WSHostName, WebSessionUser webSessionUser)
        {
            ...
            if (objWebServiceHost != null)
            {
                if (objWebServiceHost.HandShake(WSHostName))
                {
                        ...
                        return objWebServiceHost.CreateAuthenticateData(webSessionUser);
                }
            }
            return null;
        }
        ...
        /// <returns></returns>
        public static WebSessionUser Login(string strUsr, string strPwd, bool bolCertificate, bool bolPassMD5 = false)
        {
            try
            {
