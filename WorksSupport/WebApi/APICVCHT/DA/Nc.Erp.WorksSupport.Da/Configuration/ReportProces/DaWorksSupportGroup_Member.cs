   ...
   public class DaWorksSupportGroupMember
    {
       ...
       /// <param name="listWorksSupportGroupMember"></param>
        /// <returns></returns>
        public ResultMessage InsertGroup_Member(IData objIData, WorksSupportGroupMember objMember)
       {
           var objResultMessage = new ResultMessage();
           try
           {
               InsertGroup_Member(objIData, objMember.WorksSupportGroupId, objMember.UserName, objMember.WorksSupportMemberRoleId, objMember.IsAutoaddMemberToWorksSupport, objMember.CreatedUser);
