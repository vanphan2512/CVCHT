...
namespace Nc.Erp.WorksSupport.Da.Configuration.WorkSupportType
{
    ...
    public class DaWorksSupportTypeWfPermis
    {
        ...
        /// <param name="objIData"></param>
        /// <returns></returns>
        public ResultMessage DeleteDataByWorksSupportTypeId(int worksSupportTypeId, IData objIData)
        {
            var objResultMessage = new ResultMessage();
            try
            {
                DeleteByWorksSupportStepIdAndMemberRoleId(objIData, worksSupportTypeId);
            }
            catch (Exception objEx)
            {
        ...
        /// <summary>
        /// Delete EO_WORKSSUPPORTTYPE_WF_PERMIS by StepId and MemberRoleId
        /// </summary>
        /// <param name="objIData"></param>
        /// <param name="worksSupportTypeId"></param>
        protected void DeleteByWorksSupportStepIdAndMemberRoleId(IData objIData, int worksSupportTypeId)
        {
            try
            {
                objIData.CreateNewStoredProcedure(SpDelete);
                objIData.AddParameter("@WORKSUPPORTTYPEID", worksSupportTypeId);
                objIData.ExecNonQuery();
            }
            catch (Exception)
            {
