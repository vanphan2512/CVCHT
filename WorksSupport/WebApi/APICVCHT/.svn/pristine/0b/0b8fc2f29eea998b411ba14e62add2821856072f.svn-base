...
namespace WebClientAuthen
{
    ...
    public class WebSessionUser : SessionUserBO
    {
        ...
        static string WSHostNameSAMSMasterDataServices = ConfigurationManager.AppSettings["WSHost_ERPeOfficeMasterDataServices"];
        //WSHost_SAMSMasterDataServices
        ...
        public void Login(bool bolPassMD5 = false)
        {
            try
            {
                ...
                string strWSHost_SSOService9P = "WSHost_SSOService9P";
                WebServiceHost objWebServiceHost = Globals.GetWebServiceHost(strWSHost_SSOService9P);
               
                if (!objWebServiceHost.HandShake(strWSHost_SSOService9P))
                {
...
//                        HttpContext.Current.Session[RDAuthorize.hstWSUser] = this;
                ...
                {
                    Library.WebCore.FileLogger.LogAction("WebSessionUser Login Ex:  " + objEx.StackTrace);
                    this.IsLogin = false;
                }
            ...
            {
                Library.WebCore.FileLogger.LogAction("Lỗi web:" + ex.StackTrace);
                throw;
            }
        ...
        public bool LogOut()
        {
            ...
            WebServiceHost objWebServiceHost = Globals.GetWebServiceHost("WSHost_SSOService9P");
            objWebServiceHost.HandShake("WSHost_SSOService9P");
            SSOService.TokenAuthentication.TokenAuthentication objTokenAuthentication = new SSOService.TokenAuthentication.TokenAuthentication();
            objTokenAuthentication.Url = objWebServiceHost.HostURL + "TokenAuthentication.asmx";
            objTokenAuthentication.EnableDecompression = true;
            objTokenAuthentication.CookieContainer = objWebServiceHost.CookieContainer;
       ...
       /* public DataTable LoadStorePermission()
        ...
        public DataTable LoadFunctionPermission(string strUserName)
        {
            ...
            DataSet ds = null;
            ERPMasterDataServices.Users.Users.ResultMessage objResultMessage = UsersProxy.GetFunctionPermissionOfUser(ref ds, strAuthenData, strGuid, strUserName);
           // DataSet ds = UsersProxy.GetFunctionPermissionOfUser(strAuthenData, strGuid, strUserName);
            ...
            if (CheckError.CheckMissSession((int)objResultMessage.ErrorType, true))
            {
                ...
                objResultMessage = UsersProxy.GetFunctionPermissionOfUser(ref ds, strAuthenData, strGuid, strUserName);

            }

            if (!objResultMessage.IsError && ds != null && ds.Tables.Count > 0)
            {
            ...
            //    objResultMessage = SAMSWSUser.SearchData_UserDepartment_Function(strAuthenData, strGuid, ref dsFunctionPermission, strUserName);

            //    string dtmlog7 = "myhost22_" + DateTime.Now.Year + "_" + DateTime.Now.Month + "_" + DateTime.Now.Day + "_" + DateTime.Now.Hour + "_" + DateTime.Now.Minute + "_" + DateTime.Now.Second + "_" + DateTime.Now.Millisecond + ".txt";
            //    string strPath7 = "D:\\Projects\\Sources ProErp2015\\ProERP2015\\ProERP2015\\Content\\Files\\FilesContent\\" + dtmlog6;
            //    string[] lines7 = { objResultMessage.IsError.ToString(), objResultMessage.Message, SAMSWSUser.Url };
            //    System.IO.File.WriteAllLines(strPath7, lines7);
            //}
            //if (objResultMessage != null && objResultMessage.IsError)
            //{
            //    strAuthenData = RDAuthorize.GetAuthenData(WSHostNameSAMSMasterDataServices);
            //    strGuid = RDAuthorize.GetGUID(WSHostNameSAMSMasterDataServices);
            //    DataSet ds = UsersProxy.GetFunctionPermissionOfUser(strAuthenData, strGuid, strUserName);
            //    string dtmlog7 = "myhost23_" + DateTime.Now.Year + "_" + DateTime.Now.Month + "_" + DateTime.Now.Day + "_" + DateTime.Now.Hour + "_" + DateTime.Now.Minute + "_" + DateTime.Now.Second + "_" + DateTime.Now.Millisecond + ".txt";
            //    string strPath7 = "D:\\Projects\\Sources ProErp2015\\ProERP2015\\ProERP2015\\Content\\Files\\FilesContent\\" + dtmlog6;
            //    string[] lines7 = { ((ds != null && ds.Tables.Count > 0) ? "!= null" : "null"), UsersProxy.Url };
            //    System.IO.File.WriteAllLines(strPath7, lines7);
