...
namespace Nc.Erp.WorksSupport.Da.Configuration.Priority
{
    ...
    public class DaWorksSupportPriority
    {
        ...
        /// <summary>
        /// Get WorksSupportPrority by Id project
        /// </summary>
        /// <param name="objProject"></param>
        /// <param name="worksSupportProjectId"></param>
        /// <returns></returns>
        public ResultMessage GetPriorityByProjectId(ref List<WorksSupportPriority> list, int worksSupportProjectId)
        {
            var objResultMessage = new ResultMessage();
            var objIData = Data.CreateData();
            try
            {
                objIData.Connect();
                objIData.CreateNewStoredProcedure(SpSelectByIdPrority);
        ...
        /// Description     : checking priority is used.
        /// </summary>
        /// <param name="intPriorityId"></param>
        /// <param name="isUsed"></param>
        /// <returns></returns>
        public ResultMessage CheckPriorityIsUsed(int intPriorityId, ref bool isUsed)
        {
            var objResultMessage = new ResultMessage();
            var objIData = Data.CreateData();
            try
            {
                objIData.Connect();
                objIData.CreateNewStoredProcedure(SpCheckProriorityIsUsed);
                objIData.AddParameter("@WORKSSUPPORTPRIORITYID", intPriorityId);
        ...
        public const string SpSelectByIdPrority = "EO_WORKSSUPPORTPROJECT_BYID";
        public const string SpCheckProriorityIsUsed = "EO_WS_PRIORITY_CHK_USED";
        #endregion
    }
}
